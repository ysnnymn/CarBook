...
namespace CarBook.Persistence.Repositories.StatisticsRepositories
{
    public class StatisticsRepository : IStatisticsRepository
    {
        ...
        public string GetCarBrandAndModelByRentPriceMax()
        {
            ...
            string brandModel = _context.Cars.Where(x => x.CarID == carID).Include(y => y.Brand).Select(z => z.Name + " " + z.Model).FirstOrDefault();
            return brandModel;
        }
        ...
        public int GetCarCountByTransmassionIsAuto()
        {
