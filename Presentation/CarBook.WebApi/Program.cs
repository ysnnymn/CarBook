...
using CarBook.Persistence.Repositories.CommetnRepositories;
...
builder.Services.AddScoped<GetBanneerQueryHandler>();
...
builder.Services.AddScoped<GetCategoryByIQueryHandler>();
