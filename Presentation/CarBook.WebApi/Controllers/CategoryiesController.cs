...
namespace CarBook.WebApi.Controllers
{
    ...
    public class CategoryiesController : ControllerBase
    {
        ...
        private readonly GetCategoryByIQueryHandler _getCategoryByIQueryHandler;

        public CategoryiesController(CreateCategoryCommandHandler createCategoryCommandHandler, UpdateCategoryCommandHandler updateCategoryCommandHandler, RemoveCategoryCommandHandler removeCategoryCommandHandler, GetCategoryQueryHandler getCategoryQueryHandler, GetCategoryByIQueryHandler getCategoryByIQueryHandler)
        {
